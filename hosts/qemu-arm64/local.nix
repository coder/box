...
in
{
  ...
  services.coder-nixos.lanIp = "192.168.64.2";
  ...
  systemd.services.coder.environment = {
    CODER_ADMIN_EMAIL    = "admin@coder.com";  # change this
    CODER_ADMIN_USERNAME = "admin";
    CODER_ADMIN_PASSWORD = "PleaseChangeMe1234";         # change this
